...
def main(args):
    ...
    for e in range(args.epochs):
        ...
        wandb.log({"validation-time": validation_time}, commit=not args.testing)
        print("---Validation takes %s seconds ---" % validation_time)
        #print("---Validation inference (per image) takes {} seconds ---".format(validation_time/num_batches_validation/args.batch_size))
        ...
        if args.testing:
            ...
            print("---Testing inference (per image) takes {} seconds ---".format(validation_time/num_batches_validation/args.batch_size))
    wandb.log({"total-training-time": tot_training_time, "average-training-time": tot_training_time/args.epochs})


#python3 train_model.py ../data/processed/dataset_molinette20210418/dataset_molinette.yml --epochs 100 --batch_size 8 --runs-dir ../runs/dataset_molinette20210418/UNet/ --gpu 0 1 0 0
